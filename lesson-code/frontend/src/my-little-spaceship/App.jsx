      ...
      <form onSubmit={spaceshipForm.handleSubmit}>
        <div className="name">
          ...
          <input
            ...
            onBlur={spaceshipForm.handleBlur}
          />
          {spaceshipForm.touched.spaceshipName && (
        ...
        <div className="background">
          ...
          <div>
            ...
            {spaceshipForm.touched.backgroundElements && (
              <span style={{ color: "red" }}>
        ...
        <div className="material">
          ...
          <div>
            ...
            {spaceshipForm.touched.material && (
              <span style={{ color: "red" }}>
